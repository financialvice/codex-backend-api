/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 80bb8fa05f6bacfc9955a4665528fd18)
// Runtime types generated with workerd@1.20260421.1 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/worker");
		durableNamespaces: "PlaygroundAgent" | "AccountDOEncrypted";
	}
	interface Env {
		INDEX: KVNamespace;
		ASSETS: Fetcher;
		APP_HOSTNAME: "chatfaucet.com";
		PROXY_URL: "https://chatfaucet-proxy.fly.dev";
		ACCOUNT_DO: DurableObjectNamespace<import("./src/worker/worker").AccountDOEncrypted>;
		PlaygroundAgent: DurableObjectNamespace<import("./src/worker/worker").PlaygroundAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_HOSTNAME" | "PROXY_URL">> {}
}
